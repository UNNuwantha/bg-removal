...
const BgSlider = () => {
   ...
   const [sliderPosition, setSliderPostion] = useState(40)
  ...
  return (
    <div className='pb-10 md:py-20 mx-2'>
      ...
      <h1 className='mb-12 sm:mb-20 text-center text-2xl md:text-3xl lg:text-4xl mt-4 font-semibold bg-gradient-to-r from-gray-900 to-gray-400 bg-clip-text text-transparent'>Remove Background With High <br /> Quality and Accuracy</h1>
       ...
       {/* Slider */}
       <input className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-full z-10 slider' type="range" min={0} max={100} value={sliderPosition} onChange={hadleSliderChange} />
       </div>
    </div>
  )
}
